...
IV.1 CANONICAL IDENTITY — DETERMINISTIC (CME_FINGERPRINT_V1)

CME identity SHALL be content-derived and time-neutral.

CME_FINGERPRINT_V1 SHALL be computed as:
...
**Step 4 — ID Format:**
canonicalId = "CME_" + sha256hex

**Authority:**
META (MEDIA-EVENT-TRANSFORMER-AGENT) is exclusive mint authority.
No other contract may define or override CME_FINGERPRINT_V1.
